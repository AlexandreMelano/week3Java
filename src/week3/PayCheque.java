...
public class PayCheque {
    ...
    private static int nextChequeNumber = 10001; // static allows it to incriment without and instance
    ...
    /*
    this will show who the cheque is made out to, the date, cheque number 
    and the amount
    */
